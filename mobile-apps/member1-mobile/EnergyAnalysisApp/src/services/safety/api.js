...
const SAFETY_BASE_URL = process.env.EXPO_PUBLIC_SAFETY_API_URL || 'http://192.168.93.242:5004';
const SAFETY_ASSISTANT_URL = process.env.EXPO_PUBLIC_SAFETY_ASSISTANT_URL || 'http://192.168.93.242:8005';
...
async function fetchAssistant(question) {
  const res = await assistantClient.post('/ask', { question });
