...
// ─── Partner Logos ────────────────────────────────────────────────────
const PARTNER_LOGOS = [
  { name: "Solis Group", img: "data:image/png;base64," },
  { name: "LHP Energy", img: "data:image/png;base64," },
  { name: "Hayleys Solar", img: "data:image/png;base64," },
  { name: "SLSEA", img: "data:image/png;base64," },
  { name: "Surya Bala", img: "data:image/png;base64," },
  { name: "Ministry of Energy", img: "data:image/png;base64," },
];
    ...
    <div style={{ marginTop: 40, borderTop: `1px solid ${C.border}`, paddingTop: 28 }}>
      ...
      <div style={{ display: "flex", flexWrap: "wrap", justifyContent: "center", alignItems: "center", gap: 16, marginBottom: 24 }}>
        {PARTNER_LOGOS.map(({ name, img }) => (
          <div key={name} style={{ background: "#ffffff", border: `1px solid ${C.border}`, borderRadius: 10, padding: "10px 16px", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", gap: 8, width: 160, height: 90 }}>
            <img src={img} alt={name} title={name} style={{ maxWidth: "100%", maxHeight: 60, objectFit: "contain" }} />
          </div>
        ))}
      </div>
